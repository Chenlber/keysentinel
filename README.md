...
| 仓库哈希 | Key（脱敏） | 状态 | 通知日期 |
|---|---|---|---|
| `4213c991` | `sk-050***ae43` | 待核 | 2026-09-07 |
| `9bdb45aa` | `sk-a3b***6ff8` | 待核 | 2026-09-07 |
| `05425853` | `sk-593***5d82` | 待核 | 2026-09-07 |
| `6c5df4fe` | `sk-d1f***be5c` | 待核 | 2026-09-07 |
| `e6315459` | `sk-4c8***ac1e` | 待核 | 2026-09-07 |
| `012d59da` | `sk-134***54c7` | 待核 | 2026-09-07 |
| `ab4a4e87` | `sk-30e***0878` | 待核 | 2026-09-07 |
| `72a24c35` | `sk-087***c24d` | 待核 | 2026-09-07 |
| `39c33465` | `sk-2b0***67a3` | 待核 | 2026-09-07 |

> 另有 **9** 个仓库已通知但尚未确认修复。按负责任披露原则，未修复前仅展示仓库名哈希（sha256 前 8 位），不公开仓库名与文件路径。维护者确认修复后（key 已撤销）将公开其仓库名。

*数据源：`history/valid_keys.json`；更新时间：2026-09-07*
<!-- KEYS_END -->
